...
public class CartItemModel {
    ...
    public CartItemModel(int type, int productImage, String productTitle, int freeCoupens, String productPrice, String cuttedPrice, int productQuentity, int offersApplied, int coupensApplied) {
        this.type = type;
